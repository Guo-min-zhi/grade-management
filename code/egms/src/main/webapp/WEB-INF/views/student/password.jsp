        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            	<div class="col-md-8 well col-md-offset-1">
					<form id="password" class="form-horizontal" role="form" action="${ctx }/student/password" method="post">
						<div class="form-group">
							<label for="oldPassword" class="col-sm-2 control-label">原密码</label>
							<div class="col-sm-6">
								<input type="password" class="form-control" id="oldPassword" placeholder="原密码" name="oldPassword" required>
							</div>
						</div>
						<hr/>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="password" class="form-control" id="againPassword" placeholder="确认密码" name="againPassword" required>
							</div>
						</div>
						<div class="form-group">
